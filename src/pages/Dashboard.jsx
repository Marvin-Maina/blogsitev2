...
function Dashboard() {
    ...
    const navigate = useNavigate(); // ✅ FIX: Add navigate hook
        ...
        <div className="flex justify-center items-center min-h-screen bg-gray-900 p-6">
            <div className="w-full max-w-4xl bg-gray-800 text-white p-6 rounded-lg shadow-lg">
                ...
                <div className="flex gap-4 mt-4">
                    {role === "writer" && (
                        <button onClick={() => navigate("/editor")} className="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded transition">
                            ✍️ New Article
                        </button>
                    )}
                    {role === "admin" && (
