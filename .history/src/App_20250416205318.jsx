        ...
        {user && (
          <>
            ...
            <Route path="/writer-dashboard" element={
              user.role === "writer" ? <Layout><WriterDashboard /></Layout> : <Navigate to="/user-dashboard" replace />
            } />

            <Route path="/editor-dashboard" element={
              user.role === "editor" ? <Layout><EditorDashboard /></Layout> : <Navigate to="/user-dashboard" replace />
            } />

            <Route path="/admin-dashboard" element={
              user.role === "admin" ? <Layout><AdminDashboard /></Layout> : <Navigate to="/user-dashboard" replace />
            } />
