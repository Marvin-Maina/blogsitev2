...
const Signup = () => {
  ...
  // Detect "@admin.com" domain for auto admin role
  useEffect(() => {
    if (email.endsWith("@admin.com")) {
      setRole("admin");
    } else if (role === "admin") {
      setRole("user"); // Reset if email no longer ends with @admin.com
    }
  }, [email]);
    ...
    <div className="flex justify-center items-center h-screen bg-gradient-to-br from-gray-900 to-violet-900">
      <div className="bg-gray-800 text-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Show role select only if not auto-admin */}
          {!isLogin && !email.endsWith("@admin.com") && (
            <div>
