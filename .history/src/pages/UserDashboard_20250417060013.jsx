...
import ArticleModal from '../components/ArticleModal'; // Import the modal component
...
export default function UserDashboard() {
  ...
  // Local Writer's Articles from localStorage
  useEffect(() => {
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {newsArticles.map((article) => (
              ...
              >
                ...
                {/* Comment Section for News Article */}
                <div className="mt-4">
          ...
          <ul className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {userArticles.map((article) => (
              ...
              >
                ...
                {/* Comment Section for Local Article */}
                <div className="mt-4">
