...
export default function ContentEditor() {
  ...
  const handleSave = () => {
    ...
    // Simulate saving the article, like sending it to a database or API.
    setTimeout(() => {
      // For now, we’re just saving it to the console or storing it locally
      console.log("Article saved:", { title, content: contentInput });
      setSaving(false);

      // You can also handle persistence like saving the article to localStorage or sending to a backend
      localStorage.setItem("savedArticle", JSON.stringify({ title, content: contentInput }));
