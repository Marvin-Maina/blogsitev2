    ...
    return(
       ...
       <div className="w=full md:w-1/2 p-4 border border-gray-700">
            ...
            <div className="mb-2 flex gap-2">
                ...
                <button className="bg-gray-700 p-2 rounded text-sm" onClick={() => insertMarkdown("**bold**")}><Code size={18 }/></button> 
                <button className="bg-gray-700 p-2 rounded text-sm" onClick={() => insertMarkdown("**bold**")}><List size={18 }/></button> 
                <button className="bg-gray-700 p-2 rounded text-sm" onClick={() => insertMarkdown("[Link](")}><Link size={18 }/></button> 
        ...
        <div className="w-full md:w-1/2 p-4">
           ...
           <div className="p-4 bg-gray-800 border border-gray-700 rounded-lg overflow-auto h-96 "> <ReactMarkdown children={contentInput}
