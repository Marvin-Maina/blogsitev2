  ...
  return (
    <div className="p-6 ml-20 text-white h-screen bg-gray-900">
      ...
      <div
        ...
        className="border-4 border-dashed border-yellow-500 rounded-2xl p-10 flex flex-col items-center justify-center cursor-pointer hover:bg-yellow-500/10 transition mb-8"
      >
