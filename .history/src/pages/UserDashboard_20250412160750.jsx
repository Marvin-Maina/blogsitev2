...
export default function UserDashboard() {
  ...
  const [userArticles, setUserArticles] = useState([]); // New state to store published articles
  ...
  return (
    <div className={`p-6 min-h-screen font-sans transition-colors duration-300 ${
            ...
            recentActivity.map((activity, index) => (
              <li
                ...
                className={`p-4 rounded-lg border ${
                  isDarkMode ? 'bg-gray-800 border-gray-700 text-gray-200' : 'bg-gray-100 border-gray-300 text-gray-900'
                }`}
              >
      ...
      <div className="mt-10">
        <h2 className="text-3xl font-bold text-purple-300 mb-4">📝 Your Published Articles</h2>
