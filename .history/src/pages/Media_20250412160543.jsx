...
const MediaPage = () => {
  ...
  return (
    <div
      className={`p-6 ml-20 h-screen overflow-y-auto transition duration-300 ${
        isDarkMode ? "bg-gray-900 text-white" : "bg-gray-100 text-gray-950"
      }`}
    >
      <h1
      ...
      <div
        ...
        className={`border-4 border-dashed rounded-2xl p-10 flex flex-col items-center justify-center cursor-pointer transition mb-8 ${
          isDarkMode
            ? "border-violet-500 bg-gray-800 hover:bg-green-500/10 text-gray-200"
            : "border-violet-400 bg-white hover:bg-green-100 text-gray-700"
        }`}
      >
        <p className="text-lg">
